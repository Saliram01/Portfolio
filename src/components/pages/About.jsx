...
function About() {
  return (
    <div className='flex justify-center items-center h-screen'>
        <div className="w-full rounded-lg flex justify-center items-center sm:px-8">
            <div className="sm:px-12 w-full">
                <div className="px-8">
                  <h1 className='sm:text-2xl font-bold text-gray-400 mb-6'>ABOUT ME</h1>
                ...
                <div className="my-12 px-8 w-[50%]">
                  <h1 className='sm:text-2xl font-bold text-gray-400'>Java Full Stack Development</h1>
